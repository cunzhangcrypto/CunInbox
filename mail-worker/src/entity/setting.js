...
export const setting = sqliteTable('setting', {
	...
	aiProvider: integer('ai_provider').default(0).notNull(),
	aiApiKey: text('ai_api_key').default('').notNull(),
	aiBaseUrl: text('ai_base_url').default('https://api.deepseek.com').notNull(),
	aiModel: text('ai_model').default('deepseek-chat').notNull(),
	aiAnalysisStatus: integer('ai_analysis_status').default(1).notNull(),
	// AI 降级配置（主用失败时自动切换到备用）
	aiFallbackStatus: integer('ai_fallback_status').default(0).notNull(),
	aiFallbackApiKey: text('ai_fallback_api_key').default('').notNull(),
	aiFallbackBaseUrl: text('ai_fallback_base_url').default('https://api.deepseek.com').notNull(),
	aiFallbackModel: text('ai_fallback_model').default('deepseek-chat').notNull()
});
